...
export function Sidebar({ pathname }: SidebarProps) {
  ...
  return (
    <aside className="flex h-full min-h-0 w-full flex-col rounded-[2rem] border border-border/70 bg-sidebar/90 p-4 shadow-[0_20px_60px_-40px_rgba(15,23,42,0.45)] backdrop-blur">
      <BrandMark />
